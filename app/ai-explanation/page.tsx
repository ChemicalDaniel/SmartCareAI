  ...
  return (
    <div className="max-w-4xl mx-auto mt-8 p-6 bg-white rounded-lg shadow-md">
      ...
      <p className="mb-4">
        ...
        cholesterol on cardiovascular health.
      </p>
      <h2 className="text-2xl font-semibold mt-6 mb-3">Exercise Routine</h2>
      <p className="mb-4">
        The AI notes that you've maintained a consistent exercise routine, which is excellent for overall health.
        Regular physical activity contributes to better cardiovascular health, weight management, and mental wellbeing.
      </p>
